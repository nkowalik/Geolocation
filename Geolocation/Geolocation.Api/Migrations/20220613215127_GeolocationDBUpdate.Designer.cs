...
namespace Geolocation.Api.Migrations
{
    ...
    [Migration("20220613215127_GeolocationDBUpdate")]
    partial class GeolocationDBUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Geolocation.Api.Entities.Languages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Geolocation.Api.Entities.Connection", b =>
                {
                    b.HasOne("Geolocation.Api.Entities.GeolocationDetails", "Geolocation")
                        .WithOne("Connection")
            ...
            modelBuilder.Entity("Geolocation.Api.Entities.Languages", b =>
                {
                    b.HasOne("Geolocation.Api.Entities.Location", "Geolocation")
                        .WithMany("Languages")
